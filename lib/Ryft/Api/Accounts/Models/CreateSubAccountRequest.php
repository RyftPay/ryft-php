...
final class CreateSubAccountRequest implements Arrayable
{
    ...
    public function getOnboardingFlow(): ?string
    {
        return $this->onboardingFlow;
    }

    public function setOnboardingFlow(?string $onboardingFlow): self
    {
