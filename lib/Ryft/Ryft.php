...
final class Ryft
{
    ...
    public $events;
    public $files;
    public $inPersonLocations;
    public $inPersonOrders;
    public $inPersonProducts;
    public $inPersonSkus;
    public $inPersonTerminals;
    public $payouts;
    ...
    public function __construct(?string $secretKey = null)
    {
        ...
        $this->inPersonLocations = new InPersonLocationsClient($httpClient);
        $this->inPersonOrders = new InPersonOrdersClient($httpClient);
        $this->inPersonProducts = new InPersonProductsClient($httpClient);
        $this->inPersonSkus = new InPersonSkusClient($httpClient);
        $this->inPersonTerminals = new InPersonTerminalsClient($httpClient);
